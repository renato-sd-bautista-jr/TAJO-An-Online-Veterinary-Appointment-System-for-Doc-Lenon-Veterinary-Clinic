...
<body><!-- Sidebar Navigation -->
    ...
    <div id="main" class="main-content">
        ...
        <div class="container">
            ...
            <div class="card filter-card">
                <form id="filterForm" action="history1.php" method="GET" class="row g-3">
                    <div class="col-md-5">
                            ...
                            <tbody>
                                <?php foreach ($appointments as $appointment): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-info view-btn" data-id="<?php echo $appointment['id']; ?>" title="View Details">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            <?php if ($appointment['status'] !== 'Completed' && $appointment['status'] !== 'Cancelled'): ?>
                                                <a href="calendar.php?edit_appointment=<?php echo $appointment['id']; ?>" class="btn btn-sm btn-primary" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-sm btn-success complete-btn" data-id="<?php echo $appointment['id']; ?>" title="Mark as Completed">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger cancel-btn" data-id="<?php echo $appointment['id']; ?>" title="Cancel">
    ...
    <script>
        ...
        // Edit appointment - redirects to calendar.php with edit parameter
        ...
        $(document).ready(function() {
            ...
            // Edit buttons - already handled by direct link in your HTML
